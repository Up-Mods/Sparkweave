...
public class Color {
	...
	public enum Ordering implements StringRepresentable {
		...
		private final MapCodec<Color> dispatchedCodec = RecordCodecBuilder.mapCodec(instance -> instance.group(
			Codec.INT.fieldOf("value").forGetter(color -> color.asInt(this))
		).apply(instance, intValue -> Color.fromInt(intValue, this)));

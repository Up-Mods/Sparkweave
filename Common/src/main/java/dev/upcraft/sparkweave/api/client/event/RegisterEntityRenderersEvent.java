...
public interface RegisterEntityRenderersEvent {
	...
	<ENTITY extends Entity> void registerRenderer(Supplier<? extends EntityType<? extends ENTITY>> entityType, EntityRendererProvider<ENTITY> entityRendererProvider);
